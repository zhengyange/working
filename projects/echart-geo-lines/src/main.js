...
const china = require('./assets/china.json');
const shanghai = require('./assets/shanghai.json');
const beijing = require('./assets/beijing.json');

echarts.registerMap('china', china);
echarts.registerMap('shanghai', shanghai);
echarts.registerMap('beijing', beijing);

window.myChart = echarts.init(document.querySelector('#main'));
...
document.querySelector('#shanghai').addEventListener('click', function(){
    // myChart.clear();
    const option = {
        geo: {
            map: 'shanghai',
